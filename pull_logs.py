...
def main():
    if len(sys.argv) < 2:
        ...
        print(f"")
        print(f"Replace COM_PORT with your board's serial port.")
        print(f"  Windows: COM3, COM4, etc.")
        print(f"  Linux:   /dev/ttyUSB0, /dev/ttyACM0, etc.")
        print(f"  macOS:   /dev/cu.usbserial-*, /dev/cu.usbmodem*")
        print(f"")
